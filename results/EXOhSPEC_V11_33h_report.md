...
V11 is the strongest overall result in this comparison. It achieved $\color{green}{\Delta X\ \mathrm{RMS}=0.0635\ \mathrm{px}}$, $\color{green}{\Delta Y\ \mathrm{RMS}=0.1524\ \mathrm{px}}$, and $\color{green}{\text{radial RMS}=0.1634\ \mathrm{px}}$ while maintaining $\color{green}{100.0}$% of logged feedback frames within ±0.5 px for 31.44 h.
