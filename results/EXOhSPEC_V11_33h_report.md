...
| C — 15 Apr fixed model | 47.11 h | 0.3007 px | 4.9816 px | 4.9907 px | 23.32% | 8.62 | 0.70 | Fixed-model failure |
| D — 20 Apr fixed prior | 35.19 h | 0.4394 px | 5.8756 px | 5.8920 px | 28.95% | 13.19 | 1.08 | Late-run breakaway |
| E — 22–24 Apr attended | 45.24 h | 0.5254 px | 1.2015 px | 1.3113 px | 47.82% | 5.79 | 2.41 | Partial recovery; excursions remained |
| V8.3 — full MIMO | 10.64 h | Not separately reported | Not separately reported | 1.016 px | 58.4% | 3.67 | 0.56 | Late model mismatch and containment loss |
| **V11 — full feedback** | **31.44 h** | **0.0635 px** | **0.1524 px** | **0.1634 px** | **100.0%** | **2.16** | **2.19** | **Sustained closed-loop containment** |
...
> **Note:** The V11 row reports live closed-loop residuals. A conservative fixed-reference check gave radial RMS = **0.225 px** and **98.63%** of frames within ±0.5 px over the same 31.44 h interval.
